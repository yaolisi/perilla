...
help:
	...
	@echo "                   - Backend deploy slice: quick-check + no-fallback + tenant + helm + merge-gate + compose + monitoring + k8s-manifest-check（对齐 CI backend-static-analysis；无前端）"
