"""
YOLOv8Backend: 基于 TorchPerceptionRuntime 的 YOLOv8 实现
...
class YOLOv8Backend(YOLOBackend):
    name = "yolov8"
    ...
    def _ensure_loaded(self) -> None:
        ...
        from core.tools.yolo.backends._config import get_yolov8_config
        ...
        if rt is not None:
            ...
            if "yolov8" in model_id or "yolov8" in model_path:
                self._runtime = rt
            else:
                rt = None
        if rt is None:
            self._runtime = TorchPerceptionRuntime(get_yolov8_config())
