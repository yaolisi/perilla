"""
YOLOv26Backend: 基于 TorchPerceptionRuntime 的 YOLOv26 实现
...
class YOLOv26Backend(YOLOBackend):
    name = "yolov26"
    ...
    def _ensure_loaded(self) -> None:
        ...
        from core.tools.yolo.backends._config import get_yolov26_config
        ...
        if rt is not None:
            ...
            if "yolo26" in model_id or "yolo26" in model_path:
                self._runtime = rt
            else:
                rt = None
        if rt is None:
            self._runtime = TorchPerceptionRuntime(get_yolov26_config())
